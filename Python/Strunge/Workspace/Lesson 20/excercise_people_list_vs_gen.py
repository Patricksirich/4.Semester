...
def students_list(num_students):
    ...
    for i in range(num_students):
        students.append({'id': i,'name': names[random.randint(0,5)], 'major': majors[random.randint(0,4)]})
    return students
def students_generator(num_students):
    for i in range(num_students):
        yield {'id': i,'name': names[random.randint(0,5)], 'major': majors[random.randint(0,4)]}
