...
start = time.time()
students_list(1000000)
end = time.time()

print(f'students_list took', format(end-start, '.6f'), 'seconds to generate')

start = time.time()
students_generator(100000)
end = time.time()

print(f'students_generator took', format(end-start, '.6f'), 'seconds to generate')